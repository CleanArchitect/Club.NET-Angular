...
import { CleanResizeDirective } from './shared/table/directives/resize/resize.directive';
...
@Component({
    ...
    imports: [RouterModule, MatIconModule, MatToolbarModule, MatButtonModule, CleanResizeDirective, CleanTableModule],
