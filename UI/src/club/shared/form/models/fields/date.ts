...
export const dateField = <TModel>(key: KeyOf<TModel, Date | string>, label: string, options?: Partial<Pick<CleanFormFieldDate<any>, 'maxYear' | 'minYear' | CleanFormFieldOptions>>): CleanFormFieldDate<TModel> =>
