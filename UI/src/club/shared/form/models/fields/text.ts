...
export const text = <TModel>(key: KeyOf<TModel, string | number>, label: string, options?: Partial<Pick<CleanFormFieldText<TModel>, 'maxLength' | 'type' | CleanFormFieldOptions>>): CleanFormFieldText<TModel> =>
